'use strict';
moduleComponent.component('dependenciaSelection', {
    templateUrl: 'app/dependencia/selection.html',
    controllerAs: 'c',
...
function cController($http) {
    ...
    $http({
        ...
        self.ajaxDataDependenciaNumber = response.data.message;
        self.totalPages = Math.ceil(self.ajaxDataDependenciaNumber / self.rpp);
        if (self.page > self.totalPages) {
            self.page = self.totalPages;
        }
        pagination();
    }, function (response) {
        self.ajaxDataDependenciaNumber = response.data.message || 'Request failed';
        self.status = response.status;
    });
    ...
    self.save = function (id, codigo, descripcion) {
        self.obj={id : id,codigo : codigo,descripcion : descripcion};
    };
